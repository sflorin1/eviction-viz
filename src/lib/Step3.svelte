...
<div class="container" style="width: {width}px; height: {height}px; {style}">
  <div class="content-wrapper">
    ...
    <div class="chart-side">
      <iframe title="Tenant Legal Representation" aria-label="Donut Chart" id="datawrapper-chart-yc4LP" src="https://datawrapper.dwcdn.net/yc4LP/2/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="644" data-external="1">
      </iframe>
    </div>
  </div>
</div>
